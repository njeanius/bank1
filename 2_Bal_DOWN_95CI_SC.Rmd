...
## UNDERSAMPLE MAJOR/MINOR - 360 each for training

```{r}
set.seed(30)
library(caret)
down_train <- downSample(x = BM_train[, -ncol(BM_train)], y = BM_train$y)
...
sv_m<- train(Class~., data=trainsv, method="svmLinear", metric="ROC", trControl=fitctrl, tunegrid=grid, verbose=FALSE)
