...
# FS4: ANOVA - keep only 7: # 4, 8, 10, 11, 14, 15, 16 => delete 13,12,9,7,6,5,3,2,1
temp<-BM_mini_sc
temp<- temp[-13]
temp<- temp[-12]
temp<- temp[-9]
