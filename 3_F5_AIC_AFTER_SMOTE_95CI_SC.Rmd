...
# FS5: AIC step keep 10:  # 1, 4, 6, 7, 10, 11, 12, 13, 14, 16 +> delete 15,9,8,5,3,2
temp<-BM_mini_sc
temp<- temp[-15]
temp<- temp[-9]
temp<- temp[-8]
